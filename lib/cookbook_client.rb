  ...
  module Spoon
    class CookbookClient
      ...
      def do_upload(cookbook_filename, cookbook_category, user_id, user_secret_filename)
        ...
        if http_resp.code.to_i != 201
          if !res['error_messages'].nil?
            ...
            puts "http_resp.class = #{http_resp.class}"
            puts "http_resp.methods = #{http_resp.methods.sort.join(' ')}"
            puts "http_resp.code == 201: #{http_resp.code == 201}"
            puts "http_resp.code = #{http_resp.code}"
      ...
      def do_deprecate(cookbook_name, replacement_cookbook_name, user_id, user_secret_filename)
        ...
        deprecate_uri = "#{remote_cookbook.uri}/deprecation"
        ...
        # delete the whole cookbook
        @client.post(deprecate_uri, client_options)
      end
